...
PlasmoidItem {
    ...
    readonly property KeyboardIndicator.KeyState numLockState: Plasmoid.configuration.key.includes("Caps Lock") ? kiComponent.createObject(null, {key: Qt.Key_NumLock}) : null
