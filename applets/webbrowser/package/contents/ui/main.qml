...
PlasmoidItem {
    ...
    compactRepresentation: Loader {
        id: favIconLoader
        active: Plasmoid.configuration.useFavIcon && root.fullRepresentationItem && root.fullRepresentationItem.favIcon
        asynchronous: true
        sourceComponent: Image {
            asynchronous: true
            cache: false
            fillMode: Image.PreserveAspectFit
            source: root.fullRepresentationItem.favIcon
        }
        ...
        PlasmaCore.IconItem {
            anchors.fill: parent
            visible: favIconLoader.status !== Loader.Ready || favIconLoader.item.status !== Image.Ready
