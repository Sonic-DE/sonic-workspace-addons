    ...
    Repeater {
        ...
        delegate: ColumnLayout {
            ...
            PlasmaComponents.Label {
                ...
                // To compensate the lack of period label on the second row and compensate visual alignment
                Layout.bottomMargin: isFirstRow ? undefined : (periodLabel.implicitHeight + dayDelegate.spacing)
