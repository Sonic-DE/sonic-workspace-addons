...
ColumnLayout {
    ...
    PlasmaExtras.PlaceholderMessage {
        ...
        visible: (root.sourceStatus === Util.NeedsConfiguration) && (Plasmoid.formFactor === PlasmaCore.Types.Vertical || Plasmoid.formFactor === PlasmaCore.Types.Horizontal)
    ...
    PlasmaExtras.PlaceholderMessage {
        ...
        visible: root.sourceStatus === Util.Timeout
    ...
    TopPanel {
        id: topPanel
        visible: root.sourceStatus !== Util.NeedsConfiguration && root.sourceStatus !== Util.Timeout
    ...
    SwitchPanel {
        id: switchPanel
        visible: root.sourceStatus === Util.Normal
        Layout.fillWidth: true
