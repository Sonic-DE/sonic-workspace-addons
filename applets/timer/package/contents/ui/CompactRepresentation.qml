...
MouseArea {
    ...
    PlasmaCore.IconItem {
        ...
        width: Math.min(parent.parent.width, parent.parent.height)
        height: width
    ...
    ColumnLayout {
        ...
        PlasmaComponents3.Label {
            ...
            text: root.isVertical ? i18ncp("remaining time", "%1s", "%1s", root.seconds) : TimerPlasmoid.Timer.secondsToString(root.seconds, "hh:mm:ss")
        }
    }
}
