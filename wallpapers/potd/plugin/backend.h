...
public:
     ...
     * @param defaultName the default file name, defined in WallpaperInformation.qml
     * @since 5.25
     */
    Q_INVOKABLE void saveImage(const QUrl &sourceUrl, const QString &defaultName = QString());
