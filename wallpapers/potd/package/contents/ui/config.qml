...
Kirigami.FormLayout {
    ...
    ColumnLayout {
        ...
        SelectableLabel {
            id: titleLabel
            Layout.alignment: Qt.AlignHCenter
            Layout.preferredWidth: wallpaperPreview.implicitWidth * 2
    ...
    Kirigami.InlineMessage {
        ...
        readonly property bool saveSuccess: backend.saveStatus === PotdPlugin.Global.Succeeded
        property string savedUrl

        type: saveSuccess ? Kirigami.MessageType.Positive : Kirigami.MessageType.Error
        text: saveSuccess ? i18ndc("plasma_wallpaper_org.kde.potd", "@info:status after a save action %1 file path %2 basename", "The image was saved as <a href=\"%1\">%2</a>", saveMessage.savedUrl, trimFileName(saveMessage.savedUrl))
                          : i18ndc("plasma_wallpaper_org.kde.potd", "@info:status after a save action ", "Failed to save the image!")
        visible: saveSuccess || backend.saveStatus === PotdPlugin.Global.Failed
        ...
        actions: [
            Kirigami.Action {
                ...
                visible: saveMessage.saveSuccess
