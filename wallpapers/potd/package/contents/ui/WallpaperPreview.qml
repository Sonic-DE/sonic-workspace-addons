...
ColumnLayout {
    ...
    HoverHandler {
        id: hoverHandler
        readonly property bool showActions: Kirigami.Settings.isMobile || hovered || delegate.activeFocus
                                         || backend.saveStatus !== PotdPlugin.Global.None
    }
    ...
    WallpaperDelegate {
        ...
        actions: [
            ...
            Kirigami.Action {
                ...
                visible: false
                tooltip: i18ndc("plasma_wallpaper_org.kde.potd", "@action:inmenu on a button", "Open Link in Browser…")
