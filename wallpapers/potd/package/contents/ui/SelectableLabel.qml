...
QQC2.ScrollView {
    ...
    Keys.onMenuPressed: contextMenu.popup(bodyText, bodyText.x, bodyText.y + bodyText.implicitHeight);
    ...
    PlasmaComponents3.TextArea {
        ...
        TapHandler {
            ...
            onTapped: contextMenu.popup(bodyText)
        }

        TapHandler {
            acceptedDevices: PointerDevice.TouchScreen | PointerDevice.Stylus
            onLongPressed: contextMenu.popup(bodyText)
        }
