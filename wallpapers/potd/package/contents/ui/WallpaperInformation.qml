            ...
            Kirigami.Action {
                ...
                onTriggered: {
                    ...
                    if (wallpaperInformation.title.length > 0 && wallpaperInformation.author.length > 0) {
                        filename = `${wallpaperInformation.provider.charAt(0).toUpperCase() + wallpaperInformation.provider.slice(1)}-${wallpaperInformation.title}-${wallpaperInformation.author}`;
                    } else if (wallpaperInformation.title.length > 0) {
                        filename = wallpaperInformation.title;
                    }
