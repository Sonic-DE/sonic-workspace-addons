    ...
    RowLayout {
        ...
        QQC2.Label {
            ...
            text: backend.saveStatus === PotdPlugin.Global.Succeeded ?
                i18ndc("plasma_wallpaper_org.kde.potd", "@label when saving picture succeeds", "Picture saved.")
              : i18ndc("plasma_wallpaper_org.kde.potd", "@label when saving picture fails", "Failed to save the picture!")
        }
    }
