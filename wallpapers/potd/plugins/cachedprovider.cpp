    ...
    if (infoFile.exists()) {
        if (infoFile.open(QIODevice::ReadOnly)) {
            ...
            if (jsonParseError.error == QJsonParseError::NoError && jsonDoc.isObject()) {
                ...
                data[QStringLiteral("InfoUrl")] = QUrl(jsonObject.value(QStringLiteral("InfoUrl")).toString());
                data[QStringLiteral("RemoteUrl")] = QUrl(jsonObject.value(QStringLiteral("RemoteUrl")).toString());
                data[QStringLiteral("Title")] = jsonObject.value(QStringLiteral("Title")).toString();
                data[QStringLiteral("Author")] = jsonObject.value(QStringLiteral("Author")).toString();
            } else {
