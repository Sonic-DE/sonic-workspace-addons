...
public:
    Client(const KPluginMetaData &metadata, const QVariantList &args, QObject *parent = nullptr);
...
public:
     ...
     */
    Client *registerClient(const QString &identifier, const QVariantList &args);
