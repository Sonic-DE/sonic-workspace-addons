...
void DateTimeRunnerTest::testFindTimezones_data()
{
    ...
    QTest::newRow("Should find time zones with the 'in' keyword") << "in Harare" << 1 << "Africa/Harare";
}
...
void DateTimeRunnerTest::testConversion_data()
{
    ...
    const QString systemTimeZoneName = systemTimeZone.displayName(QDateTime::currentDateTime());
