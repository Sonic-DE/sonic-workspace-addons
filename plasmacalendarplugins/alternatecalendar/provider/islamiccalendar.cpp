    ...
    : ICUCalendarPrivate()
{
    ...
    case CalendarSystem::Jalali: {
        keywords = QByteArrayView("calendar=persian;");
        typicalLanguage = QLocale::Persian;
        typicalTerritory = QLocale::Iran;
        break;
    }
    case CalendarSystem::Islamic: {
        keywords = QByteArrayView("calendar=islamic;");
        break;
    }
    case CalendarSystem::IslamicCivil: {
        keywords = QByteArrayView("calendar=islamic-civil;");
        break;
    }
    case CalendarSystem::IslamicUmalqura: {
        keywords = QByteArrayView("calendar=islamic-umalqura;");
        break;
    }
    default:
        Q_UNREACHABLE();
    ...
    m_nativeLocale = icu::Locale(iso639Language, iso3166Country, nullptr, keywords.constData());
