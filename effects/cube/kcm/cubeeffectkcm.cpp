    ...
    : KCModule(parent, data)
{
    ...
    connect(ui.slider_DistanceFactor, &QSlider::sliderMoved, this, &CubeEffectConfig::updateUnmanagedState);
}
...
void CubeEffectConfig::updateConfigFromUi()
{
    ...
    CubeConfig::setDistanceFactor(distanceFactor());
...
void CubeEffectConfig::updateUiFromConfig()
{
    ...
    setDistanceFactor(CubeConfig::distanceFactor());
}

void CubeEffectConfig::updateUiFromDefaultConfig()
{
    setUiBackground(defaultBackground());
    setDistanceFactor(defaultDistanceFactor());
...
qreal CubeEffectConfig::defaultDistanceFactor() const
{
    return 1.5;
}
...
{
    unmanagedWidgetChangeState(CubeConfig::background() != uiBackground() || CubeConfig::distanceFactor() != distanceFactor());
    unmanagedWidgetDefaultState(CubeConfig::background() != defaultBackground() || CubeConfig::distanceFactor() != defaultDistanceFactor());
}
