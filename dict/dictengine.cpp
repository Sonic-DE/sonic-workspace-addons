...
void DictEngine::getDefinition()
{
    ...
    disconnect(m_definitionReadyReadConnection);
    m_definitionData.clear();

    m_definitionReadyReadConnection = connect(m_tcpSocket, &QTcpSocket::readyRead, this, &DictEngine::slotDefinitionReadyRead);
