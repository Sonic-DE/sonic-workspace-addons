        ...
        mainItem: ColumnLayout {
            ...
            ListView {
                ...
                delegate: PlasmaCore.IconItem {
                    ...
                    width: icons.iconSize + (highlightItem ? highlightItem.margins.left + highlightItem.margins.right : 0)
                    height: icons.iconSize + (highlightItem ? highlightItem.margins.top + highlightItem.margins.bottom : 0)
