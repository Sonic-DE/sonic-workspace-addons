    ...
    Window {
        ...
        PathView {
            ...
            highlight: PlasmaCore.FrameSvgItem {
                ...
                width: target ? target.width * target.scaleFactor + 6 * PlasmaCore.Units.smallSpacing : 0
                height: target ? target.height * target.scaleFactor + 6 * PlasmaCore.Units.smallSpacing : 0
