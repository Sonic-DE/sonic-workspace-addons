...
{
    m_wallpaperInfoUrl = QUrl(QStringLiteral("http://antwrp.gsfc.nasa.gov/apod/"));

    KIO::StoredTransferJob *job = KIO::storedGet(m_wallpaperInfoUrl.value(), KIO::NoReload, KIO::HideProgressInfo);
