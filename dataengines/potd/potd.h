...
private Q_SLOTS:
    ...
    void cachingFinished(const QString &source, const std::map<PotdProvider::RoleType, QVariant> &dataMap);
...
private:
    ...
    static inline const std::map<PotdProvider::RoleType, QString> m_dataKeysMap{
